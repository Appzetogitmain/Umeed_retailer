                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="relative">
                                    <span className="absolute left-2 top-1/2 -translate-y-1/2 text-neutral-400 text-xs">From:</span>
                                    <input
                                        type="date"
                                        value={fromDate}
                                        onChange={(e) => {
                                        ...
                                        className="pl-10 pr-2 py-1.5 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-teal-500 focus:outline-none w-32 sm:w-40"
                                    />
                                </div>
                                <div className="relative">
                                    <span className="absolute left-2 top-1/2 -translate-y-1/2 text-neutral-400 text-xs">To:</span>
                                    <input
                                        type="date"
                                        value={toDate}
                                        onChange={(e) => {
                                        ...
                                        className="pl-8 pr-2 py-1.5 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-teal-500 focus:outline-none w-32 sm:w-40"
                                    />
                                </div>
                            </div>
                            <button
