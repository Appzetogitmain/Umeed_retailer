    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-5 gap-3 sm:gap-4">
        ...
        <DashboardCard
          ...
          accentColor="#16a34a"
          onClick={() => navigate("/admin/orders/all", { state: { status: "Delivered" } })}
        />
        <DashboardCard
          ...
          accentColor="#a855f7"
          onClick={() => navigate("/admin/orders/all", { state: { status: "Pending" } })}
        />
        <DashboardCard
          ...
          accentColor="#ef4444"
          onClick={() => navigate("/admin/orders/all", { state: { status: "Cancelled" } })}
        />
        <DashboardCard
          icon={soldOutIcon}
