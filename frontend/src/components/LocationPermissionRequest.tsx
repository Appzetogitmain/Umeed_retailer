      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 relative">
        {skipable && (
          <button 
            ...
            className="absolute top-3 right-3 text-neutral-400 hover:text-neutral-600 transition-colors p-1.5 bg-neutral-100 hover:bg-neutral-200 rounded-full flex items-center justify-center"
            aria-label="Close"
          >
